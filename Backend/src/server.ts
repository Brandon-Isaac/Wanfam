...
import invevtoryRoutes from "./routes/inventoryRoutes";
import reccomendedRoutes from "./routes/reccomendedRoutes";
...
app.use("/api/v1/inventory", invevtoryRoutes);
app.use("/api/v1/recommendations", reccomendedRoutes);
