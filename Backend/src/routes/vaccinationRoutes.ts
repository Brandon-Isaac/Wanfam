...
router.get("/schedules/veterinarian", authenticate, roleHandler([UserRole.VETERINARY]), VaccinationController.getVaccinationSchedulesByVeterinarian);
...
router.post("/records/:animalId", authenticate, roleHandler([UserRole.FARMER, UserRole.VETERINARY]), VaccinationController.createVaccinationRecord);
