            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="text-center">
                  <p className="text-2xl font-bold text-green-600">{stats.healthyLivestock || 0}</p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6 grid grid-cols-2 gap-4">
              ...
              >
                <i className="fas fa-paw text-green-600 text-2xl mb-2"></i>
                <span className="text-sm font-medium text-green-800">Animals</span>
              </Link>
              <Link
                to={`/${farmId}/tasks`}
                className="flex flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors"
              >
                <i className="fas fa-tasks text-blue-600 text-2xl mb-2"></i>
            ...
            >
              <i className="fas fa-notes-medical text-gray-600 text-2xl mb-2"></i>
              <span className="text-sm font-medium text-gray-800">Sick Animals</span>
              </Link>
              ...
              >
                <i className="fas fa-user-md text-indigo-600 text-2xl mb-2"></i>
                <span className="text-sm font-medium text-indigo-800">Vets</span>
              </Link>
              ...
              >
                <i className="fas fa-water text-purple-600 text-2xl mb-2"></i>
                <span className="text-sm font-medium text-purple-800">Record Production</span>
              </Link>
              ...
              >
                <i className="fas fa-edit text-red-600 text-2xl mb-2"></i>
                <span className="text-sm font-medium text-red-800">Update Farm</span>
              </Link>
                     <Link
               to={`/farms/${farmId}/workers`}
               className="flex flex-col items-center justify-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors"
              >
                <i className="fas fa-users text-yellow-600 text-2xl mb-2"></i>
                <span className="text-sm font-medium text-yellow-800">Farm Workers</span>
              </Link>
            </div>
          </div>
