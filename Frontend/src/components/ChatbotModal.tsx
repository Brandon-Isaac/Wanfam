    ...
    return (
        <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-lg shadow-2xl w-full max-w-4xl h-[90vh] flex flex-col animate-scale-in">
                    {/* Header */}
                    <div className="bg-white rounded-t-lg shadow-sm border-b border-gray-200 p-4 flex-shrink-0">
                    ...
                    {/* Context Tabs */}
                    <div className="bg-white rounded-b-lg p-3 border-t border-gray-200 flex-shrink-0">
